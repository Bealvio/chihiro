...
NIX_LDFLAGS='-rpath /nix/store/l58dv8yya08fz9v98fb2i226x0h6hxgn-devenv-shell-env/lib '
export NIX_LDFLAGS
outputMan='out'
patches=''
export patches
...
export strictDeps
defaultBuildInputs=''
out='/nix/store/l58dv8yya08fz9v98fb2i226x0h6hxgn-devenv-shell-env'
export out
...
NIX_CFLAGS_COMPILE=' -frandom-seed=l58dv8yya0 -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include'
...
'
export shellHook
prefix='/nix/store/l58dv8yya08fz9v98fb2i226x0h6hxgn-devenv-shell-env'
...
exec /tmp/devenv-envkpOZeL/script 