...
OLDPWD=''
export OLDPWD
out='/nix/store/h559fayndzv2fym4jb6yl1c5sw90k9bw-devenv-shell-env'
export out
IN_NIX_SHELL='impure'
export IN_NIX_SHELL
outputBin='out'
...
AS='as'
export AS
NIX_CFLAGS_COMPILE=' -frandom-seed=h559fayndz -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include'
...
export NIX_BINTOOLS
CHIHIRO_REDIS_ADDR='localhost:6379'
...
prefix='/nix/store/h559fayndzv2fym4jb6yl1c5sw90k9bw-devenv-shell-env'
depsBuildBuild=''
...
export CC
LINENO='79'
NIX_LDFLAGS='-rpath /nix/store/h559fayndzv2fym4jb6yl1c5sw90k9bw-devenv-shell-env/lib '
export NIX_LDFLAGS
...
exec /tmp/devenv-envuryUjT/script 